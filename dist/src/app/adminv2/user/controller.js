...
exports.getUserTransactions =
  ...
  exports.actionEdit =
  exports.indexEdit =
  exports.actionDelete =
  exports.actionCreate =
  exports.indexCreate =
  exports.index =
    void 0;
...
const index = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const [users] = yield db_1.default.query(
      ...
      const userBalances = yield Promise.all(
        users.map((user) =>
          __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            try {
              ...
              if (player_id) {
                const balanceResponse = yield axios_1.default.post(
                ...
                const balance =
                  ((_b =
                    (_a = balanceResponse.data) === null || _a === void 0
                      ? void 0
                      : _a.data) === null || _b === void 0
                    ? void 0
                    : _b.data) || 0; // Default balance 0 jika tidak ada data
                // Return user dengan balance yang diperbarui
                return Object.assign(Object.assign({}, user), { balance });
              } else {
                // Jika tidak ada player_id, kembalikan balance 0
                return Object.assign(Object.assign({}, user), { balance: 0 });
              }
            } catch (error) {
              console.error(
...
const actionCreate = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const [checkEmail] = yield db_1.default.query(
      ...
      const [checkUsername] = yield db_1.default.query(
      ...
      // Hash the password
      const passwordBrcypted = yield bcryptjs_1.default.hash(
        password,
        saltRounds
      );
...
const getUserTransactions = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const [totalIncomeRows] = yield db_1.default.query(
        `SELECT 
      ...
      const [totalSpendRows] = yield db_1.default.query(
        `SELECT 
      ...
      const [countRows] = yield db_1.default.query(
