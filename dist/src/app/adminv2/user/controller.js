...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userBalances = yield Promise.all(users.map((user) => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            try {
                const { player_id } = user; // Ambil player_id dari user
                // Jika player_id ada, ambil balance dari API
                if (player_id) {
                    const balanceResponse = yield axios_1.default.post("https://api.innovativetechnology.my.id/api/v1/str/balance", { player_id: player_id }, // Kirimkan player_id
                    {
                        headers: {
                    ...
                    const balance = ((_b = (_a = balanceResponse.data) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.data) || 0; // Default balance 0 jika tidak ada data
                ...
                console.error(`Error fetching balance for player_id ${user.player_id}:`, error.message || error);
